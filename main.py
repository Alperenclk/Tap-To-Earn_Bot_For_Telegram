...
def templateMatching(imagePath, threshold=0.5):
...
#     exe_file_directory = "C:\\Dev\\Tap-To-Earn_Bot_For_Telegram\\scrcpy-win64-v2.4"
...
def main():
    ...
    ## Hit the boss
    imagePath = "templates\\boss_body_huawei.png"
